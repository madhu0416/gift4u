...
/* =========================================================
   ...
   You can later connect these categories to real product pages.
   ========================================================= */
...
/* =========================================================
   ...
   Later, you can replace this static data with Firebase data.
   ========================================================= */
...
export default function LifestylePage() {
  ...
  /* =======================================================
     ...
     The Header can listen for the "cartUpdated" event and
     ...
     Make sure your Cart page and Header use the same key.
     ======================================================= */
  ...
  const addToCart = (product: Product) => {
    ...
    if (existingProductIndex !== -1) {
      ...
      setToastMessage("Product quantity updated in cart!");
    } else {
      cart.push({
        ...product,
        quantity: 1,
    ...
    localStorage.setItem("gift4u-cart", JSON.stringify(cart));

    /*
      =======================================================
      NOTIFY HEADER

      Header should listen to this event.
    ...
    <>
      ...
      <main className="bg-[#fffafc] text-[#172033]">
        ...
        {/* ===================================================
            ...
            public/images/lifestyle-hero.jpg
            ...
            You can also add a dark overlay above the image
          ...
          <div className="mx-auto grid max-w-7xl items-center gap-10 px-4 py-16 lg:grid-cols-2 lg:px-8 lg:py-20">
            ...
            <div className="relative z-10">
              <div className="mb-6 flex h-14 w-14 items-center justify-center rounded-full bg-white shadow-sm">
                <Sparkles className="text-[#d92f66]" size={26} />
              </div>
              ...
              <p className="mt-5 max-w-xl text-lg leading-8 text-[#667085]">
                Discover thoughtful gifts inspired by fashion, home,
                personality, hobbies and everything that makes someone
                unique.
              </p>
            ...
            <div className="relative min-h-[320px] overflow-hidden rounded-[2.5rem] border border-[#ead2dc] bg-white sm:min-h-[400px]">
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center bg-gradient-to-br from-[#fff6f9] to-[#f3e7ed] p-6 text-center">
                <div className="flex h-20 w-20 items-center justify-center rounded-full bg-[#f8dfe8]">
                  <ShoppingBag size={34} className="text-[#d92f66]" />
                </div>
                ...
                <p className="mt-2 max-w-xs text-sm text-[#667085]">
                  Fashion, home décor, accessories and lifestyle gifts
                </p>
              </div>
            </div>
          </div>
        ...
        {/* ===================================================
            ...
            ALL ITEMS USE THE SAME:
            LARGE ROUNDED RECTANGLE SHAPE

            This keeps the section consistent and structured.
            =================================================== */}
          ...
          <div className="mx-auto max-w-7xl px-4 lg:px-8">
            <div className="mb-9">
              ...
              <p className="mt-3 max-w-2xl text-[#667085]">
                Find gifts inspired by personal style, hobbies, home and
                everyday passions.
              </p>
            </div>
          ...
          <div className="mx-auto max-w-7xl px-4 lg:px-8">
            <div className="flex items-end justify-between gap-5">
              <div>
                ...
                <p className="mt-3 max-w-2xl text-[#667085]">
                  Thoughtful gifts to make every home feel more beautiful,
        ...
        {/* ===================================================
            ...
            This section remains visually consistent.
            =================================================== */}
          ...
          <div className="mx-auto max-w-7xl px-4 lg:px-8">
            <div className="text-center">
              ...
              <p className="mx-auto mt-3 max-w-2xl text-[#667085]">
                Choose thoughtful gifts for the people who make your life
                special.
              </p>
            </div>
        ...
        {/* ===================================================
            ...
            PRODUCT CARDS HAVE SAME SIZE
            Similar to Newly Launched section on homepage.
          ...
          <div className="mx-auto max-w-7xl px-4 lg:px-8">
            <div className="mb-9">
              ...
              <p className="mt-3 text-[#667085]">
                Handpicked gifts that combine style, comfort and personality.
              </p>
            </div>
        ...
        {/* ===================================================
            ...
            ALL CARDS USE:
            SAME DIAMOND / ROTATED SQUARE STYLE
        ...
        <section className="bg-white py-16">
          <div className="mx-auto max-w-7xl px-4 lg:px-8">
            <div className="mb-10">
              ...
              <p className="mt-3 max-w-2xl text-[#667085]">
                Every person is different. Find a gift that matches what
                they love.
              </p>
            </div>
            ...
            {/* ===============================================
                ...
                SAME SHAPE USED FOR EVERY ITEM
                =============================================== */}
        ...
        <section className="bg-[#172033] py-16">
          <div className="mx-auto max-w-7xl px-4 lg:px-8">
            <div className="grid items-center gap-10 lg:grid-cols-[0.9fr_1.1fr]">
              ...
              <div>
                ...
                <p className="mt-4 max-w-lg text-lg leading-8 text-[#cbd5e1]">
                  Make little moments unforgettable with toys, games,
                  personalised surprises and gifts made especially for kids.
                </p>
        ...
        {/* ===================================================
            ...
            Add a large lifestyle image here later.
            =================================================== */}
            ...
            <div className="relative overflow-hidden rounded-[2.5rem] bg-[#172033] px-6 py-14 sm:px-10 lg:px-16 lg:py-16">
              <div className="relative z-10 max-w-2xl">
                ...
                <p className="mt-4 text-lg leading-8 text-[#cbd5e1]">
                  From everyday favourites to unforgettable surprises,
                  explore gifts that match every personality and lifestyle.
                </p>
              ...
              {/* ===============================================
                  ...
                  public/images/lifestyle-banner.jpg


                  Example:

                  <img
                    src="/images/lifestyle-banner.jpg"
                    alt="Lifestyle Gifts"
      ...
      {/* =====================================================
          ...
          Appears at bottom after clicking Add to Cart.
          ===================================================== */}
